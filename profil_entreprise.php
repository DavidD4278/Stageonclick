...
<body  class=" bg-profil.entr text-align">
    ...
    ?>
    <section class="container col-lg-4  text-center mx-auto my-5 rounded-top-5 rounded-bottom-5 ">
        <div class="row">
            <div class="col-12">
                ...
                <form class="bg-primary mb-3 text-light rounded-3 p-3" action="./scripts/entreprises/modifCompteEntr.php" method="post">
                    <div class="mb-3 text-center">
                ...
                <form class="bg-primary mb-3 text-light rounded-3 p-3" action="./scripts/entreprises/modifAdresse.php" method="post">
                    <div class="mb-3 text-center">
                ...
                <form class="bg-primary mb-3 text-light rounded-3 p-3" action="./scripts/entreprises/modifierCodePostal.php" method="post">
                    <div class="mb-3 text-center">
                ...
                <form class="bg-primary text-center text-light rounded-3 p-3" action="./scripts/entreprises/modifMDPEntr.php" method="post">
                    <div class="mb-3 text-center">
